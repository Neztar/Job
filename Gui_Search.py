...
typemenu = ["กฎหมาย", "การตลาด", "บัญชี/การเงิน", "คลังสินค้า/โลจิสติกส์", "งานบันเทิง/นักแสดง/นักร้อง/นางแบบ",
            ...
            "คอมพิวเตอร์/โปรแกรมเมอร์", "นักเขียน/บรรณาธิการ/นักแปลภาษา", "ล่าม/มัคคุเทศก์", "วิทย่ศาสตร์/วิจัยพัฒนา",
            "วิศวกร", "สื่อสานมวลชน", "ออกแบบเว็บไซต์", "เลขานุการ", "สิ่งแวดล้อม/เจ้าหน้าที่ความปลอดภัย",
...
# drop dowm menu
specmenu = ["ประจำ", "พาร์ททาม", "ฟรีแลน", "ฝึกงาน"]
